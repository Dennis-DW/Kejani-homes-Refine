...
const PropertyDetails = () => {
  ...
  const isCurrentUser = user.email === propertyDetails.creatorID.email;
            ...
            <Stack direction="row" flexWrap="wrap" justifyContent="space-between" alignItems="center" gap={2}>
              ...
              <Box>
                ...
                <Stack direction="row" alignItems="flex-end" gap={1}>
                  ...
                  <Typography fontSize={14} color="#808191" mb={0.5}>Monthly</Typography>
                </Stack>
              </Box>
            </Stack>
        ...
        <Box width="100%" flex={1} maxWidth={326} display="flex" flexDirection="column" gap="20px">
          ...
          >
            ...
            <Stack mt={2} justifyContent="center" alignItems="center" textAlign="center">
              <img
                src={propertyDetails.creatorID.avatar}
                width={90}
                height={90}
              ...
              <Box mt="15px">
                <Typography fontSize={18} fontWeight={600} color="#11142D">{propertyDetails.creatorID.name}</Typography>
                <Typography mt="5px" fontSize={14} fontWeight={400} color="#808191">Landlord</Typography>
              </Box>

              <Stack mt="15px" direction="row" alignItems="center" gap={1}>
                <Place sx={{ color: '#808191' }} />
                <Typography fontSize={14} fontWeight={400} color="#808191">Nairobi, Kenya</Typography>
              </Stack>

              <Typography mt={1} fontSize={16} fontWeight={600} color="#11142D">{propertyDetails.creatorID.allProperties.length} Properties</Typography>
            </Stack>

            <Stack width="100%" mt="25px" direction="row" flexWrap="wrap" gap={1}>
              <CustomButton
